          ...
          <table class="table table-striped table-bordered" >
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="hapus.php?id=<?= $swa["id"]; ?>" onclick= "return confirm('Apakah anda yakin ingin menghapus?')""><i class="fas fa-trash-alt ml-3" data-togle="tooltip" title="Hapus"></i></a>
                </td>
              </tr>
              <?php $i++; ?>
              <?php endforeach; ?>
